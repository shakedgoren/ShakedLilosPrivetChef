 ...
 * השם ישב על תמונה שנראית דרכו. הנקודה שבה המסך מתחיל להיסגר כמעט
 * לא זזה (0.44 → 0.40), ולכן **כמות התמונה הנראית לא השתנתה**;
 * מה שהשתנה הוא הצפיפות מתחת לכתב עצמו.
 */
const VEIL_STOPS = [
  { offset: 0, alpha: 0 },
  { offset: 0.4, alpha: 0 },
  { offset: 0.62, alpha: 0.9 },
  { offset: 0.72, alpha: 1 },
  { offset: 1, alpha: 1 },
] as const;
...
const s = StyleSheet.create({
  ...
  /**
   * ⚠ **הודגש · 16 בספטמבר 2026** · המשקל היה 200, הקו הדק שהיא
   * בחרה בסבב הראשון. היא ביקשה מאז, פעמיים, שהכתב יהיה בולט.
   * ⚠ **ההדגשה הקודמת נחתה בקובץ הלא נכון** · היא נכתבה ב-
   * `CategoryCard`, שאינו מרונדר בדף הבית כלל — רק שני קבועי
   * הנקודות שלו מיובאים. לכן שקד לא ראתה שום שינוי במכשיר.
   */
  title: {
    fontSize: 27,
    fontWeight: '700',
  ...
  /* ⚠ הועלה מ-300 ומ-`#6E6478` · אפור דק על מסך חלקי אינו נקרא */
  desc: {
    fontSize: 10.5,
    fontWeight: '400',
    lineHeight: 16.3,
