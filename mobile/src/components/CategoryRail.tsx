 ...
 * כ-66% מקוטר הבועה.
 *
 * ⚠ **שני סבבי הגדלה** · שקד ביקשה ״תגדיל עוד קצת את העיגול עצמו
 * וגם את האייקון שבתוכו שזה יהיה ברור יותר״, ואז ״תגדיל עוד קצת רק
 * את האייקונים עצמם שיהיו יותר גדולים בתוך הבועה״. הבועה 62→70
 * והאיור 41→50→56, כלומר האיור תופס עכשיו **80%** מהבועה במקום 66%
 * שבתמונת הייחוס. זה מכוון — שתי הבקשות היו מפורשות.
 *
