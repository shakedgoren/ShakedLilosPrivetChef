...
/* ==========================================================================
   כפתורי הכניסה והיציאה · מהתמונה של שקד, 26 בספטמבר 2026
   --------------------------------------------------------------------------
   ⚠ **הערכים נדגמו מהקובץ עצמו ולא נבחרו בעין.** שקד שלחה תמונה
   של שני הכפתורים וכתבה ״תבנה אותם בדיוק אותו הדבר״. חתך אנכי דרך
   כל אחד מהם נתן את הגרדיאנט:

     גוף הגלולה   #CED3FC למעלה → #B1BCFA למטה
     הידית        #8E8FE0, ושפה תחתונה כהה #6C68B2
     כפתור היציאה #9091DD, ושפה תחתונה #726FAA

   ⚠ **הידית עגולה ולא ריבוע מעוגל** · כך היא בתמונה. היה
   `CTA_KNOB_RADIUS = 11`, והוא נשאר בקובץ כי כפתורים אחרים
   עדיין משתמשים בו.
   ========================================================================== */

/** גוף הגלולה · בהיר למעלה, מעט עמוק יותר למטה */
export const CTA_PILL_STOPS = ['#CED3FC', '#B1BCFA'] as const;
/** הידית · אותה משפחה, רוויה יותר */
export const CTA_KNOB_FILL = '#8E8FE0';
/** השפה התחתונה של הידית · מה שנותן את הנפח */
export const CTA_KNOB_EDGE = 'inset 0 -3px 0 rgba(84,78,150,0.42), 0 3px 8px -2px rgba(60,48,84,0.45)';
/** הכיתוב · לבן מלא בתמונה */
export const CTA_LABEL_INK = '#FFFFFF';
/** המילוי שנחשף בגרירה · אותה משפחה, כהה מהגוף ובהיר מהידית */
export const CTA_SLIDE_STOPS = ['#B6BCF7', '#A3AAF3', '#AEB5F5'] as const;

/** כפתור ההתנתקות · אותו עיגול, בלי גלולה מסביבו */
export const LOGOUT_FILL = '#9091DD';
export const LOGOUT_EDGE = 'inset 0 -3px 0 rgba(78,73,132,0.4), 0 4px 10px -3px rgba(40,32,60,0.5)';
