...
export const surface = {
  /**
   * ⚠ **גוון הדף · שונה ב-16 בספטמבר 2026** · שקד: ״כל דף הבית
   * הראשי לבן מידי״. מתוך חמישה גוונים היא בחרה את ״לילך״ — הסגול
   * של המותג כרקע. היה `#FCFBFB`, לבן כמעט מוחלט.
   * ⚠ זה משנה את **כל** מסכי האפליקציה, כי `PageWash` צובע כל עמוד.
   */
  ground: '#F3EFFA',
  ink: '#2A2430',
  inkSoft: '#4A4254',
