...
/**
 * ⚠ **הוגדל והורד · 16 בספטמבר 2026** · שקד ביקשה ״הלוגו מצד ימין
 * צריך מעט לרדת למטה ולהיות יותר גדול״. היה 46 ב-`top: 30`, באותו
 * גובה של חץ החזרה בשאר המסכים — אבל כאן אין חץ חזרה שיאזן אותו.
 */
const LOGO = 62;
const LOGO_TOP = 48;
const LOGO_SIDE = 18;
