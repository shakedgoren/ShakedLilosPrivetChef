...
export function BoxesScreen() {
   ...
   */
  /**
   * ⚠ **`!== null` ולא בדיקת אמת · באג שהיה כאן מלכתחילה, נמצא
   * ב-18 בספטמבר 2026** · `o.current` הוא **אינדקס** המארז הפתוח,
   * והמארז הראשון הוא ‎0. בדיקת אמת רגילה מחשיבה אפס כ״סגור״, ולכן
   * חזרה מתוך **המארז הראשון** קפצה לדף הבית במקום לרשימה — בדיוק
   * מה ששקד ביקשה שלא יקרה. בשאר המארזים זה עבד, ולכן זה לא נתפס.
   *
