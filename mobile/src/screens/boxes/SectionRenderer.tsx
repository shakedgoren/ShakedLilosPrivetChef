 ...
 */
const FADE_RGB = 'rgb(198,228,211)';
/**
 * עצירות הרצועה · מהירוק למעלה אל השקוף.
 *
 * ⚠ **התמזגות ולא רצועה · 18 בספטמבר 2026** · שקד ראתה שתי תצוגות
 * מקדימות. על הראשונה אמרה ״ההתמזגות נכונה אבל זה צריך להיות יותר
 * למטה, יותר על החלק הירוק ולא על התמונה עצמה ודק יותר״, ועל
 * המתוקנת בחרה **אופציה א׳**.
 *
 * לכן שני שינויים: הרצועה **ירדה** (‎16 במקום 26 גובה, ומתוכן 12
 * בתוך הירוק במקום 9), והצבע עצמו **אינו עוד להבה לבנה במרכז**
 * אלא הירוק שמתמוסס כלפי מעלה. ככה אין נקודה אחת שאפשר להצביע
 * עליה ולומר ״כאן זה מתחיל״.
 */
