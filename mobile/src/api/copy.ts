...
export const COPY = {
  ...
  /**
   * ⚠ **נוסח חדש · נכתב על ידי Claude, שקד לא כתבה אותו** ·
   * מוצג כשהשרת מחזיר `sent: false`, כלומר Meta דחתה את השליחה.
   * עד היום המסך התעלם מזה והמשיך למסך הקלדת הקוד.
   */
  otpNotSent: 'לא הצלחנו לשלוח את קוד האימות בוואטסאפ · אפשר לנסות שוב בעוד חצי דקה, או להתקשר 052-505-6708',
