 ...
 */
/**
 * הטלפון של העסק · משמש גם כיעד להעברה בביט ובפייבוקס כל עוד
 * אין קישור תשלום.
 *
 * ⚠ **הוחלף ב-19 בספטמבר 2026** · שקד: ״אני מנסה לסדר מספר אחר,
 * תעדכן בכל מקום באפליקציה את המספר טלפון שהיה קודם 052-9770915
 * להיות המספר החדש 052-5056708״. הקודם נמסר ב-17 בספטמבר.
 */
export const BUSINESS_PHONE = '052-5056708';
...
/**
 * ⚠ **ירד מהשימוש · 19 בספטמבר 2026** · מחרוזת קבועה מהקנבס
 * שהוצגה **ללקוחה בסיכום ההזמנה** ובכותרות מסכי הניהול, בלי קשר
 * ליום המכירה האמיתי. במקומה `saleDateText(upcomingSale(…).date)`
 * ב-`data/calendar`. נשארת כאן רק כדי לא לשבור את הקנבס.
 */
