...
const s = StyleSheet.create({
  ...
  dueTitle: { fontSize: 16, fontWeight: '600', color: '#A65E2A' },
  dueSub: { fontSize: 14, color: '#A65E2A' },
  impDone: { fontSize: 14.5, color: '#4E8A64', fontWeight: '500' },
  cats: { gap: 6 },
  ...
  name: { flex: 1, fontSize: 16.5, fontWeight: '600', color: surface.ink },
  auto: { fontSize: 11.5, fontWeight: '700', color: '#7B5CBC' },
  sumLine: { fontSize: 13, color: surface.faint },
  bodyCard: { gap: 8, borderTopWidth: 1, borderTopColor: 'rgba(130,112,162,0.14)', paddingTop: 10 },
  note: { fontSize: 14, color: '#6E6478' },
  sec: { fontSize: 13, fontWeight: '600', color: surface.faint },
  from: { fontSize: 14.5, color: surface.ink },
  cols: { flexDirection: 'row', gap: 6 },
  col: { fontSize: 11.5, color: '#C4BDCE' },
  ...
  lab: { fontSize: 12, fontWeight: '500', color: '#8A8194', marginBottom: 3, textAlign: 'center' },
  bigInp: {
    width: '100%',
    height: 40,
    borderRadius: 13,
  ...
  foot: { fontSize: 13, color: surface.faint, paddingVertical: 8 },
  empty: { fontSize: 15, color: '#A79FB2', textAlign: 'center', padding: 20 },
  buy: { paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: 'rgba(130,112,162,0.12)' },
  buyT: { fontSize: 16, color: surface.ink },
});
