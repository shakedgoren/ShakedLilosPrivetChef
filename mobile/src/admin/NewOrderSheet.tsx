...
const s = StyleSheet.create({
  ...
  bookName: { flex: 1, fontSize: 15, fontWeight: '500', color: surface.ink },
  bookPhone: { fontSize: 13, color: '#A79FB2' },
  warn: {
    borderRadius: 14,
    paddingVertical: 10,
  ...
  warnText: { fontSize: 14, fontWeight: '600', color: '#A65E2A' },
  sum: {
    borderRadius: 16,
    paddingVertical: 12,
  ...
  sumLabel: { fontSize: 14.5, color: surface.inkSoft },
  sumValue: { fontSize: 15, fontWeight: '600', color: surface.ink },
  rule: { height: 1, backgroundColor: 'rgba(130,112,162,0.16)' },
  totalLabel: { fontSize: 15.5, fontWeight: '600', color: surface.ink },
  totalValue: { fontSize: 20.5, fontWeight: '700', color: COUS.deep },
  notify: { fontSize: 13, fontWeight: '300', lineHeight: 17, color: surface.muted, textAlign: 'center' },
  cta: {
    alignSelf: 'center',
    height: 48,
