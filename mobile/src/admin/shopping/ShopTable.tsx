...
const s = StyleSheet.create({
  ...
  groupName: { flex: 1, fontSize: 14, fontWeight: '600', letterSpacing: 0.7, color: '#A79FB2' },
  groupCount: { fontSize: 12.5, fontWeight: '500', color: '#C4BDCE' },

  cols: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 10 },
  col: { fontSize: 11.5, fontWeight: '500', color: '#C4BDCE' },
  colName: { flex: 1 },
  ...
  check: { fontSize: 12.5, fontWeight: '700', color: '#FFFFFF', lineHeight: 13 },
  nameSlot: { flex: 1 },
  name: { fontSize: 14.5, fontWeight: '500' },
  cell: { fontSize: 14, color: surface.faint },
  sum: { fontSize: 14.5, fontWeight: '700', color: '#43307A' },
  dropSlot: { width: 18, alignItems: 'center' },
  dropGlyph: { fontSize: 12.5, color: '#C4BDCE' },

  empty: { alignItems: 'center', gap: 4, paddingVertical: 60 },
  emptyTitle: { fontSize: 16, fontWeight: '500', color: '#A79FB2' },
  emptySub: { fontSize: 13, color: surface.muted },
});
