...
const s = StyleSheet.create({
  ...
  initial: { fontSize: 17, fontWeight: '700' },
  main: { flex: 1 },
  nameRow: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  name: { fontSize: 17, fontWeight: '600', color: surface.ink },
  tag: { borderRadius: 7, paddingHorizontal: 7, paddingVertical: 1 },
  tagText: { fontSize: 11.5, fontWeight: '700' },
  line: { fontSize: 13, color: surface.faint, marginTop: 2 },
  noteFlag: { fontSize: 12.5, fontWeight: '500', color: '#A65E2A', marginTop: 4 },
  spent: { fontSize: 16.5, fontWeight: '600', color: surface.ink, textAlign: TEXT_END },
  spentTag: { fontSize: 12, color: '#A79FB2', textAlign: TEXT_END },
  more: { gap: 8, borderTopWidth: 1, borderTopColor: 'rgba(130,112,162,0.14)', paddingTop: 10 },
  row: { flexDirection: 'row', justifyContent: 'space-between', gap: 8 },
  rowK: { fontSize: 14, color: surface.faint },
  rowV: { fontSize: 14.5, color: surface.ink, flex: 1, textAlign: TEXT_END },
  ...
  noteLab: { fontSize: 13, fontWeight: '500', color: surface.faint },
  noteInput: {
    height: 42,
    borderRadius: 13,
  ...
  actText: { fontSize: 14, fontWeight: '600', color: '#43307A' },
  actGoText: { fontSize: 14, fontWeight: '600', color: '#43307A' },
  histRow: { paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: 'rgba(130,112,162,0.12)', gap: 2 },
  histK: { fontSize: 12.5, color: surface.faint },
  histT: { fontSize: 15, color: surface.ink },
  histV: { fontSize: 14, color: '#6E6478' },
});
