...
const s = StyleSheet.create({
  ...
  statusText: { fontSize: 11.5, fontWeight: '700', letterSpacing: 1 },
  source: { fontSize: 11.5, fontWeight: '600', color: '#A79FB2' },
  who: { fontSize: 18, fontWeight: '600', color: surface.ink },
  line: { fontSize: 14, fontWeight: '300', color: surface.muted },
  /* בקנבס המספרים מיושרים לצד החיצוני של הכרטיס · ב-RTL זהו flex-end */
  side: { alignItems: 'flex-end' },
  sum: { fontSize: 18.5, fontWeight: '600', color: surface.ink },
  time: { fontSize: 13, fontWeight: '500' },
  chev: { fontSize: 16, color: '#A79FB2' },
  body: { gap: 10 },
  rule: { height: 1, backgroundColor: 'rgba(130,112,162,0.14)' },
  row: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
  rowKey: { width: 78, fontSize: 13, fontWeight: '300', color: surface.muted, lineHeight: 18 },
  rowVal: { flex: 1, fontSize: 14.5, fontWeight: '500', color: surface.ink, lineHeight: 18 },
  ...
  callText: { fontSize: 14.5, fontWeight: '600', color: surface.inkSoft },
  next: { flex: 2, height: 38, borderRadius: 999, alignItems: 'center', justifyContent: 'center' },
  nextText: { fontSize: 14.5, fontWeight: '600' },
  kill: {
    width: 38,
    height: 38,
    borderRadius: 19,
  ...
  killGlyph: { fontSize: 16, fontWeight: '700', color: '#B95349' },
});
