...
const s = StyleSheet.create({
  ...
  card: {
    ...
    left: 16,
    /**
     * ⚠ **ברירת מחדל אנכית · 19 בספטמבר 2026** · שקד: ״כשאני
     * לוחצת על ייבוא הפופ אפ שקופץ ממש למעלה לא רואים אותו״.
     *
     * הכרטיס ממוקם מוחלט וכל קורא נתן `top` משלו ב-`style`.
     * חלונית הייבוא לא נתנה, ולכן היא נדבקה ל-`top: 0` — מתחת
     * למגרעת ומחוץ לאזור הבטוח.
     *
     * ⚠ **הקורא עדיין גובר** · `style` מגיע אחרי זה במערך, ולכן
     * שבע החלוניות שכן נותנות מיקום לא הושפעו.
     */
    top: 150,
    borderRadius: 28,
    padding: 18,
