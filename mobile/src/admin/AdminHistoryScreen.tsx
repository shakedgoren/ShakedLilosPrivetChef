...
const s = StyleSheet.create({
  ...
  count: { fontSize: 13, color: '#A79FB2', marginTop: 2 },
  sum: { fontSize: 17, fontWeight: '700', color: '#43307A' },
  ...
  cell: { fontSize: 14.5, color: surface.ink },
  grow: { flex: 1 },
  ...
  catTotalK: { flex: 1, fontSize: 15, fontWeight: '600', color: '#43307A' },
  catTotalV: { fontSize: 17, fontWeight: '700', color: '#43307A', fontVariant: ['tabular-nums'] },
  total: { fontSize: 15, fontWeight: '600', color: '#43307A', marginTop: 4 },
});
