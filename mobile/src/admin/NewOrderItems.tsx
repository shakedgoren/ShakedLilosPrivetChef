...
const s = StyleSheet.create({
  ...
  itemPrice: { fontSize: 12.5, fontWeight: '300', color: '#A79FB2' },
  ...
  count: { minWidth: 20, textAlign: 'center', fontSize: 18 },
  ...
  rollText: { flex: 1 },
  rollName: { fontSize: 14.5, fontWeight: '600', color: SCHN.deep },
  rollTops: { fontSize: 12.5, fontWeight: '300', color: surface.muted, marginTop: 1 },
  rollPrice: { fontSize: 14.5, fontWeight: '600', color: SCHN.deep },
  rollDrop: { fontSize: 14, color: '#A79FB2' },
  ...
  addName: { fontSize: 14, fontWeight: '600', color: SCHN.deep },
  addPrice: { fontSize: 12, color: surface.muted },
});
