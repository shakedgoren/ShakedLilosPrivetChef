...
export default function App() {
  ...
  return (
    <SafeAreaProvider>
      ...
      <LightboxProvider>
        {/**
          * ⚠ **מתעלמים מכל השוליים הבטוחים** · בקשה של שקד
          * (15 בספטמבר 2026), `ignoresSafeArea(_:edges:)` — קודם
          * התחתית ואז גם העליון. `edges={[]}` משאיר את
          * ה-`SafeAreaView` בלי ריפוד בכלל, והמסכים מנהלים את
          * הריווח העליון בעצמם.
