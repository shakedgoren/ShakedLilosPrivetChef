...
const names = ['BOXES','CONCEPTS','CONCEPT_FAM','TIERS','TIER_LINES','STYLES','STYLES_ALL','ALLERGY','DISLIKE','DIET','KITCHEN','OCCASION','DAYPART','CHEF_PRICES','MEAT_DONE','FISH_DONE','FISH','TABOON_TIERS','SALAD_BASE','SALAD_EXTRA','PASTA_BASE','PASTA_EXTRA','PASTA_UP_EXTRA','DESSERT_BASE','DESSERT_EXTRA','FIRST_EXTRA','T_FIRSTS','T_TABLE','T_EXTRAS','T_ALLERGY','PASTA_SHAPES','T_PASTA_UPS','T_SALADS','T_PASTAS','T_DESSERTS','EXTRAS','EXTRA_TABLE','EXTRA_DRINK','PICK_FROM','PICK_TO','DELIV_FROM','DELIV_TO','DELIV_STEP'];
